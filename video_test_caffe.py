# -*- coding: UTF-8 -*-  
import sys
sys.path.append('/home/ambavm/RefineDet/python/')
import caffe
import os
import numpy as np
import cv2
...
class Timer(object):
    ...
    def toc(self, average=True):
        ...
        if average:
            ...
            return self.diff
caffe_root = "/home/ambavm/RefineDet/"
if os.path.isfile(caffe_root + 'models/ResNet/coco/refinedet_resnet50_512x256/coco_refinedet_resnet50_512x256_iter_1470000.caffemodel'):
    print 'CaffeNet found.'
else:
    print 'CaffeNet not found'
model_def = caffe_root + 'models/ResNet/coco/refinedet_resnet50_512x256/deploy.prototxt'
model_weights = caffe_root + 'models/ResNet/coco/refinedet_resnet50_512x256/coco_refinedet_resnet50_512x256_iter_1470000.caffemodel'
...
test_image_path=caffe_root+'examples/images/images'
