...
Just need two steps .
First ,you need to comment plot_one_box() fucntion in "yolov5/utils/utils.py" on line 913.
Second ,Change the path of image_file to be annotated.
Third ,build a file named "output" in inference file to save the mirrored images.
All labeled XML file are all saved in the same path with the images.
'''
