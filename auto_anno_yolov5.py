...
Just need two steps .
First ,you need to annotate plot_one_box() fucntion in "yolov5/utils/utils.py" on line 913.
Second ,Change the path of image_file to be annotated.
'''
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    if label: 
        ...
        xml_file.write('        <name>' + str(label.split(" ")[0]) + '</name>\n')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        a=0
        im_names = os.listdir('/home/ambavm/make/yolov5/inference/images/')   # The path of the images needed to be annotated.
        for label_name in im_names:
           image_file = '/home/ambavm/make/yolov5/inference/images/' + label_name
           image = cv2.imread(image_file) 
           img_size = image.shape
           height=img_size[0]
           width=img_size[1]

           # Create head of  the XML file
           ...
           xml_file.write('        <annotation>AUTO by fan</annotation>\n')
